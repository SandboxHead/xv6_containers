...
extern int sys_get_container(void);
extern int sys_open_old(void);
...
[SYS_get_container]       sys_get_container,
[SYS_open_old]            sys_open_old,
...
extern int syscall_counter[NUM_SYSCALLS + 1];
